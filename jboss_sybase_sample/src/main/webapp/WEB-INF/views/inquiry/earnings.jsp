            ...
            <main class="content-wrapper" id="content">
                <section class="content">
                    ...
                    <div class="content-white EMP-detail">
                        ...
                        <div class="clearfix">
                            <div class="total-table  pull-left">
                                ...
                                >
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="print-tr">
                                            <td>Emplr Sponsored Health Covrg:</td>
                                            <td></td>
                                            <td>1,799.00</td>
                                        </tr>
                                    </tbody>
                            ...
                            <div class="tips-table pull-left">
                                        ...
                                        <table class="table border-table">
                                            ...
                                            <table class="table border-table no-print">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="total-tr">
                                                        <td>Total Non-TRS Taxable Pay:</td>
                                                        <td>0.00</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <table class="table border-table no-print">
                                                <thead>
                                                    <tr>
                                                        <th>Non-TRS Non-Taxable Type</th>
                                                        <th>This Period</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                ...
                                <div class="deduction-table">
                                        <table  class="table border-table earning-left-table">
                                                <thead>
                                                    <tr>
                        ...
                        <div class="print-block hr-black"></div>
                        <table class="table responsive-table border-table print-table">
                                <thead>
                                    <tr>
                                        <th>Leave Type</th>
                                        <th>Units Used This Period</th>
                                        <th>Balance</th>
                                        <th class="print-td">Units Used Year To Date</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td data-title="Leave Type">02 - LOCAL SICK</td>
                                        <td data-title="Units Used This Period">1.000</td>
                                        <td data-title="Balance">3.500</td>
                                        <td class="print-td" data-title="Units Used Year To Date">1.500</td>
                                    </tr>
                                    <tr>
                                        <td data-title="Leave Type">08 - STATE PERSON</td>
                                        <td data-title="Units Used This Period">0.000</td>
                                        <td data-title="Balance">8.000</td>
                                        <td class="print-td" data-title="Units Used Year To Date">3.000</td>
                                    </tr>
